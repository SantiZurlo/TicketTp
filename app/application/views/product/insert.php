<?php $this->load->view('includes/header'); ?>
    ...
    <div class="flex w-full items-center justify-center">
        <div class="p-5 bg-white rounded-xl w-3/5 lg:w-2/3">
            <h3 class="font-semibold text-slate-900 pb-6 text-lg">Agregar Nuevo Espectáculo</h3>
            <div class="panel-body">
                <form action="<?=base_url('espectaculo/agregar')?>" method="post" enctype="multipart/form-data" class="space-y-4">                              
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="description" class="focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none w-full text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-md py-2 px-4 ring-1 ring-slate-200 shadow-sm resize-none" placeholder="Ingrese una descripción" autofocus></textarea>
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900" for="units">Cantidad de Tickets</label>
                        <input type="number" name="units" class="focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none w-full text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-md py-2 px-4 ring-1 ring-slate-200 shadow-sm" placeholder="Ingrese la cantidad de ticksts" autofocus>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="file" name="imagefile" class="focus:ring-2 focus:ring-blue-500 focus:outline-none appearance-none w-full text-sm leading-6 text-slate-900 placeholder-slate-400 rounded-md py-2 px-4 ring-1 ring-slate-200 shadow-sm" placeholder="Ingrese una imagen" autofocus>
                    </div>
